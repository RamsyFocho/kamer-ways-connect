...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "grid w-full grid-cols-3 h-12 rounded-lg bg-background p-1 text-muted-foreground",
      "border border-border", // Add border
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "rounded-md hover:bg-muted/50", // Hover state
      className
    )}
    {...props}
  />
