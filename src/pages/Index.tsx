...
const Index = () => {
  ...
  const features = [
    ...
    },
    {
      icon: Shield,
      title: "Safe Travel",
      description: "GPS tracking and insurance coverage",
    },
    {
      icon: Clock,
      title: "24/7 Support",
    ...
    },
    {
      icon: MapPin,
      title: "Wide Network",
      description: "Connecting major cities across Cameroon",
    },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Choose from our trusted network of bus agencies for a comfortable
              and safe journey
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 ">
              {filteredAgencies.length > 0 ? (
                ...
                <div className="col-span-full text-center py-12">
                  <p className="text-lg">No Agency found</p>
                </div>
              )}
            </div>
          )}
